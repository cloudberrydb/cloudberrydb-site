...
`reindexdb` is a wrapper around the SQL command [`REINDEX`](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-reindex.md). There is no effective difference between reindexing databases via this utility and via other methods for accessing the server.
...
[REINDEX](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-reindex.md)
