...
[CREATE SEQUENCE](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-create-sequence.md), [DROP SEQUENCE](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-drop-sequence.md), [ALTER TABLE](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-alter-table.md)
