...
A query (`SELECT` statement) that supplies the rows to be inserted. Refer to the [SELECT](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-select.md) statement for a description of the syntax.
...
Possible limitations of the query clause are documented under [SELECT](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-select.md).

## See also

[SELECT](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-select.md)
