...
Refer to [SET](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-set.md) for details.
...
[SET](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-set.md), [SHOW](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-show.md)
