...
It is possible to create an enumerated type with zero labels, but such a type cannot be used to hold values before at least one label is added using [ALTER TYPE](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-alter-type.md).
...
[ALTER TYPE](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-alter-type.md), [CREATE DOMAIN](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-create-domain.md), [CREATE FUNCTION](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-create-function.md), [DROP TYPE](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-drop-type.md)
