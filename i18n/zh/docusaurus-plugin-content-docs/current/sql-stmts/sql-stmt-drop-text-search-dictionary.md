...
[ALTER TEXT SEARCH DICTIONARY](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-alter-text-search-dictionary.md), [CREATE TEXT SEARCH DICTIONARY](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-create-text-search-dictionary.md)
