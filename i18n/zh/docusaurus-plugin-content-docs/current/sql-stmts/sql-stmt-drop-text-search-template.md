...
[ALTER TEXT SEARCH TEMPLATE](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-alter-text-search-template.md), [CREATE TEXT SEARCH TEMPLATE](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-create-text-search-template.md)
