...
Additional restrictions apply when unique indexes are applied to partitioned tables; see [CREATE TABLE](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-create-table.md).
...
The system regularly collects statistics on all of a table's columns. Newly-created non-expression indexes can immediately use these statistics to determine an index's usefulness. For new expression indexes, you must run [ANALYZE](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-analyze.md) to generate statistics for these indexes.
...
Use [DROP INDEX](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-drop-index.md) to remove an index.
...
[ALTER INDEX](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-alter-index.md), [DROP INDEX](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-drop-index.md)
