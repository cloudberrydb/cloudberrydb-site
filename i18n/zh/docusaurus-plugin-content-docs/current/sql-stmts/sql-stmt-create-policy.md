...
[ALTER POLICY](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-alter-policy.md), [DROP POLICY](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-drop-policy.md), [ALTER TABLE](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-alter-table.md)
