...
[ALTER SEQUENCE](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-alter-sequence.md), [DROP SEQUENCE](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-drop-sequence.md)
