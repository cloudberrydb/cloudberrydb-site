...
The table data in the tablespace directory is not dropped. You can use the [ALTER TABLE](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-alter-table.md) command to change the tablespace defined for the table and move the data to an existing tablespace.
