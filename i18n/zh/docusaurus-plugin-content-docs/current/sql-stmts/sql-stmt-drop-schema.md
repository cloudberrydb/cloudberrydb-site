...
[CREATE SCHEMA](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-create-schema.md), [ALTER SCHEMA](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-alter-schema.md)
