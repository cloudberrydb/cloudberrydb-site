...
[CREATE SERVER](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-create-server.md), [DROP SERVER](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-drop-server.md)
