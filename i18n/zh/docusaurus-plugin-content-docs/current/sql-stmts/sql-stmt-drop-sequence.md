...
[ALTER SEQUENCE](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-alter-sequence.md), [CREATE SEQUENCE](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-create-sequence.md)
