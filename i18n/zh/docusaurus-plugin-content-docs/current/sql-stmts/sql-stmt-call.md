...
To call a function (not a procedure), use [SELECT](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-select.md) instead.
...
[CREATE PROCEDURE](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-create-procedure.md)
