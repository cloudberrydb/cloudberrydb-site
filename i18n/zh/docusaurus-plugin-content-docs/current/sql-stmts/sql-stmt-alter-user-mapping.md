...
[CREATE USER MAPPING](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-create-user-mapping.md), [DROP USER MAPPING](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-drop-user-mapping.md)
