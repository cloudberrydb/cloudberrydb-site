...
See the description of the [GRANT](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-grant.md) command for the meaning of the privilege types.
...
See [GRANT](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-grant.md).
...
The compatibility notes of the [GRANT](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-grant.md) command also apply to `REVOKE`.

Either `RESTRICT` or `CASCADE` is required according to the standard, but Cloudberry Database assumes `RESTRICT` by default.

## See also

[ALTER DEFAULT PRIVILEGES](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-alter-default-privileges.md), [GRANT](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-grant.md)
