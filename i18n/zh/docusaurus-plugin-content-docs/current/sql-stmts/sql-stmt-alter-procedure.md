...
Change whether the procedure is a security definer or not. The key word `EXTERNAL` is ignored for SQL conformance. See [CREATE PROCEDURE](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-create-procedure.md) for more information about this capability.
...
[CREATE PROCEDURE](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-create-procedure.md), [DROP PROCEDURE](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-drop-procedure.md)
