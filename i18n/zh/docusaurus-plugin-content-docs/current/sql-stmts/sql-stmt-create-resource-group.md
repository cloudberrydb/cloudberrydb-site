...
After creating a resource group for a role, assign the group to one or more roles using the [ALTER ROLE](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-alter-role.md) or [CREATE ROLE](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-create-role.md) commands.
...
[ALTER ROLE](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-alter-role.md), [CREATE ROLE](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-create-role.md), [ALTER RESOURCE GROUP](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-alter-resource-group.md), [DROP RESOURCE GROUP](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-drop-resource-group.md)
