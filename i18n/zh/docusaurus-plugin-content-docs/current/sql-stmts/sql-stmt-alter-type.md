...
Adds a new attribute to a composite type, using the same syntax as [CREATE TYPE](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-create-type.md).
...
[CREATE TYPE](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-create-type.md), [DROP TYPE](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-drop-type.md)
