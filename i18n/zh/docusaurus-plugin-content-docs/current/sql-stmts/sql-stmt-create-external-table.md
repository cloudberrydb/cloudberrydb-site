...
[CREATE TABLE AS](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-create-table-as.md), [CREATE TABLE](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-create-table.md), [COPY](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-copy.md), [SELECT INTO](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-select-into.md), [INSERT](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-insert.md)
