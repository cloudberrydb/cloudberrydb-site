...
[CREATE FUNCTION](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-create-function.md), [CREATE TYPE](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-create-type.md), [DROP CAST](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-drop-cast.md)
