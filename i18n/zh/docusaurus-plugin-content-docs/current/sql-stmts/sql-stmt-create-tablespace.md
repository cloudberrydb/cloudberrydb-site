...
A user with appropriate privileges can pass tablespace_name to [CREATE DATABASE](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-create-database.md), [CREATE TABLE](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-create-table.md), or [CREATE INDEX](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-create-index.md) to direct Cloudberry Database to store the data files for these objects within the specified tablespace.
