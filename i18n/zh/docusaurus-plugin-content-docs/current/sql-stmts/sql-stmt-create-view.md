...
This parameter may be either `local` or `cascaded`, and is equivalent to specifying `WITH [ CASCADED | LOCAL ] CHECK OPTION` (see below). This option can be changed on existing views using [ALTER VIEW](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-alter-view.md).
...
A [SELECT](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-select.md) or [VALUES](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-values.md) command which will provide the columns and rows of the view.
...
Use the [DROP VIEW](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-drop-view.md) statement to drop views.
...
[ALTER VIEW](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-alter-view.md), [DROP VIEW](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-drop-view.md), [CREATE MATERIALIZED VIEW](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-create-materialized-view.md)
