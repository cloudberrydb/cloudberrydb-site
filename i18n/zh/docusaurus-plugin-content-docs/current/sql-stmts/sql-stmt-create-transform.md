...
Use [DROP TRANSFORM](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-drop-transform.md) to remove transforms.
...
[CREATE FUNCTION](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-create-function.md), [CREATE LANGUAGE](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-create-language.md), [CREATE TYPE](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-create-type.md), [DROP TRANSFORM](/i18n/zh/docusaurus-plugin-content-docs/current/sql-stmts/sql-stmt-drop-transform.md)
