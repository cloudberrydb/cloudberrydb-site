...
[CREATE FUNCTION](/docs/sql-statements/sql-statement-create-function.md), [CREATE TYPE](/docs/sql-statements/sql-statement-create-type.md), [DROP CAST](/docs/sql-statements/sql-statement-drop-cast.md)
