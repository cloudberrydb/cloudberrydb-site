...
[CREATE OPERATOR FAMILY](/docs/sql-statements/sql-stmt-create-operator-family.md), [DROP OPERATOR FAMILY](/docs/sql-statements/sql-stmt-drop-operator-family.md), [ALTER OPERATOR CLASS](/docs/sql-statements/sql-stmt-alter-operator-class.md), [CREATE OPERATOR CLASS](/docs/sql-statements/sql-stmt-create-operator-class.md), [DROP OPERATOR CLASS](/docs/sql-statements/sql-stmt-drop-operator-class.md)
