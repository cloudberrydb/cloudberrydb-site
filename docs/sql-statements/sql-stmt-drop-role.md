...
A role cannot be removed if it is still referenced in any database; an error will be raised if so. Before dropping the role, you must drop all the objects it owns (or reassign their ownership) and revoke any privileges the role has been granted on other objects. The [REASSIGN OWNED](/docs/sql-statements/sql-stmt-reassign-owned.md) and [DROP OWNED](/docs/sql-statements/sql-stmt-drop-owned.md) commands can be useful for this purpose.
...
[REASSIGN OWNED](/docs/sql-statements/sql-stmt-reassign-owned.md), [DROP OWNED](/docs/sql-statements/sql-stmt-drop-owned.md), [CREATE ROLE](/docs/sql-statements/sql-stmt-create-role.md), [ALTER ROLE](/docs/sql-statements/sql-stmt-alter-role.md), [SET ROLE](/docs/sql-statements/sql-stmt-set-role.md)
