...
The [DROP OWNED](/docs/sql-statements/sql-stmt-drop-owned.md) command is an alternative that simply drops all of the database objects owned by one or more roles.
...
[DROP OWNED](/docs/sql-statements/sql-stmt-drop-owned.md), [DROP ROLE](/docs/sql-statements/sql-stmt-drop-role.md), [ALTER DATABASE](/docs/sql-statements/sql-stmt-alter-database.md)
