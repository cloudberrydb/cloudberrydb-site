...
[DROP TEXT SEARCH TEMPLATE](/docs/sql-statements/sql-stmt-drop-text-search-template.md), [ALTER TEXT SEARCH TEMPLATE](/docs/sql-statements/sql-stmt-alter-text-search-template.md)
