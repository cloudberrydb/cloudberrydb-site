...
See the description of the [GRANT](/docs/sql-statements/sql-stmt-grant.md) command for the meaning of the privilege types.
...
See [GRANT](/docs/sql-statements/sql-stmt-grant.md).
...
The compatibility notes of the [GRANT](/docs/sql-statements/sql-stmt-grant.md) command also apply to `REVOKE`.

Either `RESTRICT` or `CASCADE` is required according to the standard, but Cloudberry Database assumes `RESTRICT` by default.

## See Also

[ALTER DEFAULT PRIVILEGES](/docs/sql-statements/sql-stmt-alter-default-privileges.md), [GRANT](/docs/sql-statements/sql-stmt-grant.md)
