...
The `USING` expression for the policy. See [CREATE POLICY](/docs/sql-statements/sql-stmt-create-policy.md) for details.

**`check_expression`**

The `WITH CHECK` expression for the policy. See [CREATE POLICY](/docs/sql-statements/sql-stmt-create-policy.md) for details.
...
[CREATE POLICY](/docs/sql-statements/sql-stmt-create-policy.md), [DROP POLICY](/docs/sql-statements/sql-stmt-drop-policy.md)
