...
If `SET TRANSACTION` is run without a prior [START TRANSACTION](/docs/sql-statements/sql-stmt-start-transaction.md) or [BEGIN](/docs/sql-statements/sql-stmt-begin.md), it emits a warning and otherwise has no effect.
...
[BEGIN](/docs/sql-statements/sql-stmt-begin.md)
