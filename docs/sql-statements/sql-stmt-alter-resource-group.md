...
Use [CREATE ROLE](/docs/sql-statements/sql-stmt-create-role.md) or [ALTER ROLE](/docs/sql-statements/sql-stmt-alter-role.md) to assign a specific resource group to a role (user).
...
[CREATE RESOURCE GROUP](/docs/sql-statements/sql-stmt-create-resource-group.md), [DROP RESOURCE GROUP](/docs/sql-statements/sql-stmt-drop-resource-group.md), [CREATE ROLE](/docs/sql-statements/sql-stmt-create-role.md), [ALTER ROLE](/docs/sql-statements/sql-stmt-alter-role.md)
