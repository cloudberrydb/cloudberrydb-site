...
For more information on query planning and the statistics collected by Cloudberry Database for that purpose, see the [ANALYZE](/docs/sql-statements/sql-stmt-analyze.md) documentation.
...
[EXECUTE](/docs/sql-statements/sql-stmt-execute.md), [DEALLOCATE](/docs/sql-statements/sql-stmt-deallocate.md)
