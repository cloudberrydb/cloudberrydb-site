...
Use [DROP TRANSFORM](/docs/sql-statements/sql-stmt-drop-transform.md) to remove transforms.
...
[CREATE FUNCTION](/docs/sql-statements/sql-stmt-create-function.md), [CREATE LANGUAGE](/docs/sql-statements/sql-stmt-create-language.md), [CREATE TYPE](/docs/sql-statements/sql-stmt-create-type.md), [DROP TRANSFORM](/docs/sql-statements/sql-stmt-drop-transform.md)
