...
[CREATE TEXT SEARCH TEMPLATE](/docs/sql-statements/sql-stmt-create-text-search-template.md), [DROP TEXT SEARCH TEMPLATE](/docs/sql-statements/sql-stmt-drop-text-search-template.md)
