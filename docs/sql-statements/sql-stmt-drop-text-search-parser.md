...
[ALTER TEXT SEARCH PARSER](/docs/sql-statements/sql-stmt-alter-text-search-parser.md), [CREATE TEXT SEARCH PARSER](/docs/sql-statements/sql-stmt-create-text-search-parser.md)
