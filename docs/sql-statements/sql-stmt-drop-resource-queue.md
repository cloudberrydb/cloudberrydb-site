...
Use [ALTER ROLE](/docs/sql-statements/sql-stmt-alter-role.md) to remove a user from a resource queue.
...
[ALTER RESOURCE QUEUE](/docs/sql-statements/sql-stmt-alter-resource-queue.md), [CREATE RESOURCE QUEUE](/docs/sql-statements/sql-stmt-create-resource-queue.md), [ALTER ROLE](/docs/sql-statements/sql-stmt-alter-role.md)
