...
It is possible to create an enumerated type with zero labels, but such a type cannot be used to hold values before at least one label is added using [ALTER TYPE](/docs/sql-statements/sql-stmt-alter-type.md).
...
[ALTER TYPE](/docs/sql-statements/sql-stmt-alter-type.md), [CREATE DOMAIN](/docs/sql-statements/sql-stmt-create-domain.md), [CREATE FUNCTION](/docs/sql-statements/sql-stmt-create-function.md), [DROP TYPE](/docs/sql-statements/sql-stmt-drop-type.md)
