...
[CREATE TEXT SEARCH PARSER](/docs/sql-statements/sql-stmt-create-text-search-parser.md), [DROP TEXT SEARCH PARSER](/docs/sql-statements/sql-stmt-drop-text-search-parser.md)
