...
[gpssh-exkeys](/docs/system-utilities/db-util-gpssh-exkeys.md), [gpdeletesystem](/docs/system-utilities/db-util-gpdeletesystem.md), [Start and Stop Cloudberry Database](/docs/start-and-stop-cbdb-database.md)
