...
The `gpmemreport` utility helps interpret the output file created by the [gpmemwatcher](/docs/system-utilities/db-util-gpmemwatcher.md) utility.
...
[gpmemwatcher](/docs/system-utilities/db-util-gpmemwatcher.md)
