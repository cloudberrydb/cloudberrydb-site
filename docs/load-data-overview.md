---
title: Load Data Overview
---

# Overview of Loading Data into Cloudberry Database

The topics in this section describe methods for loading and writing data into Cloudberry Database.

Cloudberry Database supports high-performance parallel data loading, and for smaller amounts of data, single file, non-parallel data import.

Cloudberry Database can read from several types of external data sources, including text files and CSV.
