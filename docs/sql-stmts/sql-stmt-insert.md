...
A query (`SELECT` statement) that supplies the rows to be inserted. Refer to the [SELECT](/docs/sql-stmts/sql-stmt-select.md) statement for a description of the syntax.
